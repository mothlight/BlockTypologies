...
Our method 800m x 800m samples of custom abstract / stylised maps from Google Maps of the world's largest 1692 cities. Using a floodfill, the size and regularity of each city blocks in a samples is calculated and histograms constructed for each map sample. A self organising map (SOM), that deploys a unsupervised learning algorithm is used, for feature detection and to cluster (arrange) these images into city block typologies. 
...
\begin{figure}[!htbp]
\centering    
%a) \includegraphics[scale=0.04,page=1]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%b) \includegraphics[scale=0.04,page=2]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%c) \includegraphics[scale=0.04,page=3]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%\\
%d) \includegraphics[scale=0.04,page=4]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%e) \includegraphics[scale=0.04,page=5]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%f) \includegraphics[scale=0.04,page=6]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%\\
%g) \includegraphics[scale=0.04,page=7]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%h) \includegraphics[scale=0.04,page=8]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%i) \includegraphics[scale=0.04,page=9]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
%\\
%j) \includegraphics[scale=0.04,page=10]{Images/output15VarBinsSize135USCitiesImages10clusters.pdf}  
...
%\begin{figure}[!htbp]
%    \centering    
% \includegraphics[scale=0.30]{Images/CityClusters15VarBinsSize135USCitiesImages10clusters.png}  
%\caption{\bf Locations of clusters for 135 United States cities. Outer marker colour shows the cluster that the largest number of locations in the city belong. Inner marker colour shows the 2nd largest locations. }    
% \label{fig:clustermaplocations}  
%\end{figure} 
%
%\begin{figure}[!htbp]
%    \centering    
% \includegraphics[scale=0.50]{Images/InnerCityClustersNYC-crop.png}  
%\caption{\bf Locations of clusters for 135 United States cities. Detail of inner city locations for New York, New York. }    
