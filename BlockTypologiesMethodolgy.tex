...
%\begin{algorithm}[H]
%\SetAlgoLined
%\KwResult{List of region sizes and region regularity for an image }
% Start at top left point of image\;
% \While{While Locate the first white pixel iterating across rows and columns}{
%   floodfill the area using boundaries of all non-white colors (i.e. black roads, green space, blue water)\;
%  }
% }
% \caption{How to write algorithms}
%\end{algorithm}

%Start at top left point of image, locate the first white pixel iterating across rows and columns. Once a white pixel is located, floodfill the area using boundaries of all non-white colors (i.e. black roads, green space, blue water). Record the region size in a Sqlite3 database. 

%Also, for this area, find four rectangular vertices, finding x1 with the lowest x value, y2 with the lowest y value, x2 with the highest x value, and y2 with the highest y value. Using the four vertices (point\_x\_min,point\_y\_min), (point\_y\_min, point\_x\_max), (point\_x\_max,point\_y\_max), (point\_y\_max,point\_x\_min), count the number of pixels outside of the rectangle and save that value in the Sqlite3 database. 

%Repeat all steps until all white regions in the image have been completed.
...
\begin{figure}[!htbp]
    \centering    
a) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster0.png}  
b) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster1.png} 
c) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster2.png} 
\\
d) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster3.png}  
e) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster4.png} 
f) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster5.png} 
\\
g) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster6.png}  
h) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster7.png} 
i) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster8.png} 
\\
j) \includegraphics[scale=0.04]{Images/MontageHistogramBothCluster9.png}  

\caption{\bf Clusters a) 0, b) 1, c) 2, etc. of individual maps from 95 United States cities, showing only the top 60 map images closest to the centre of the clusters.}    
...
\begin{figure}[!htbp]
    \centering    
 \includegraphics[scale=0.30]{Images/CityClusters6.png}  
\caption{\bf Locations of clusters for 95 United States cities. Outer marker colour shows the cluster that the largest number of locations in the city belong. Inner marker colour shows the 2nd largest locations. }    
 \label{fig:clustermaplocations}  
\end{figure} 

\begin{figure}[!htbp]
    \centering    
 \includegraphics[scale=0.50]{Images/InnerCityClustersDenver-Crop.png}  
\caption{\bf Locations of clusters for 95 United States cities. Detail of inner city locations for Denver, Colorado. }    
 \label{fig:clustermapdenverlocations}  
\end{figure} 
...
\begin{figure}[!htbp]
    \centering    
a) \includegraphics[scale=0.05,page=1,trim = 0mm 1815mm 0mm 0mm,clip]{Images/cityClusteringOutput.pdf}  \\
 b) \includegraphics[scale=0.05,page=2,trim = 0mm 1815mm 0mm 0mm,clip]{Images/cityClusteringOutput.pdf}  \\
 c)  \includegraphics[scale=0.05,page=3,trim = 0mm 1815mm 0mm 0mm,clip]{Images/cityClusteringOutput.pdf}  
