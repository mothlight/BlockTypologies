...
\begin{figure}[!htbp]
\centering    
\includegraphics[scale=0.80]{Images/Melbourne_5_Final-01.png}  
\caption{\bf  Map of Melbourne, Australia with 24027 individual map segments classified and colour coded. Note, the CBD shows additional points due to inclusion of the 1000 circular sampling procedure in addition to the 400m resolution sampling. }    
 \label{fig:mel23000}  
\end{figure} 
