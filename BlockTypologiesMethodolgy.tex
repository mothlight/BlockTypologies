...
The 1.7 million maps histograms were organised using a custom built self organizing map (SOM), written in Java 8 \citep{Oracle2018}. The SOM was constructed with a width and height of 100 and run with 3.2 million iterations of training. The radius decay was calculated as
