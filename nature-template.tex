...
The presented project is investigating the strucutre of human settlments and proposes a objective, evidence based method to investigate individual urban strcutres. This is a absolute new level of granulatity which is essential for many other field that use the urban environment as an imput parameter like public health, urban economics, transportation planing.

% Non-Scientific audience
Is your neighborhood similar to Soho in London or Kibera in Neirobi: this new methodology is comparing neighborhoods of all cities around the world with more than 300,000 inhabitants. It's method can be used to push many fields to insights on a new, fine grained, level of your neighborhood. 

% Number of Fig. | manuscripts | Supplementary Information

- 1.6 million Image Data points
- Github
