...
This method is not limited to detecting differences within a city, but is able to use a neighbourhood sample in one city and identify similar locations in all other cities. In the collection of XXX cities indicates how different the respective map samples are classified by the SOM and which areas are similar. TODO, not sure what this last sentence means.
