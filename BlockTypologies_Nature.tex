...
% 150 words
% Motivation
Cities are the stage of human interactions, the foundation of society, a large source of pollution, and the habitat of the majority of the world's population. Although each field investigates cities from its own vantage point, we lack an objective method to compare cities around the world and some therefore believe that each city is unique. This has led to repeated reinvention of solutions for problems that occur globally. Additionally, the lack of comparable measurement methods between and within cities starves us of the possibility to learn from previous examples.

% % % % support statement about cities being unique % %

% City's 'uniqueness' 
Cities grow, evolve and change. Analysing the basic structural elements of road networks and urban blocks provides clues as to the processes and governance under which city development occurs. The built environment influences a wide range of outcomes, including health, transport, and economic opportunity. Methods to study cities through these basic structural elements are essential to many disciplines conducting urban research and provide a foundation on which they can conduct their research.
% Implication of city structure and form
 % and in particular / especially the road network and block typology,%

% Solution
This paper presents a methodology that can reliably compare not only cities but individual neighbourhoods within and between cities in a robust manner using an unsupervised learning algorithm and global map imagery. 
% Results
...
% our solution
We propose a novel, quantitative, and objective method to discover global city typologies on a neighbourhood scale of street patterns by evaluating city block size and regularity. This follows Louf \& Barthelemy's finding\cite{Louf2014a} that a systematic quantitative method to identify different neighbourhoods is currently lacking. 
%% solution is globally applicabl | updates easily |  Robust | new city characteristics | can accomodate additonal data |
Our method uses imagery from Google Maps of custom, abstract, and stylized maps of approximately 400x400m sections of the world's largest 1667 cities, encompassing 31\% of the world's population. Using a computer vision floodfill technique, the size and regularity of city blocks in the map samples are calculated and histogram representations constructed for each. 
A self organising map (SOM) is then used to sort the histograms, projecting the high dimensional space onto a 2-dimensional plane, revealing distinct city block typologies (see Figure \ref{fig:somresults}). 

% Results
%% Method is robust visible by global results
%% intra inter city similarities
%% Examples from Melbourne (and other cities)
The methodology has evaluated $>$1.7 million map segments, showing the robustness and global applicability of the methodology (see Figure \ref{fig:world}). The results of the SOM are used to colour code and highlight the map samples according to their sorted location within the SOM. This process uncovers similarities between individual city neighbourhood locations and has shown capable of detecting city archetypes such as city centres, suburban areas, and even more ephemeral entities such as the city edges (see Figure \ref{fig:mel23000}).
%% "similarities between city locations" sounds like we compare the locations maybe change to "similarities between city neighbourhoods" or "within cities" to tie it to the next paragraph
 
This method is not limited to detecting differences within a city, but is able to use neighbourhood samples of one city and identify similar neighbourhoods across the globe. The global and heterogeneous collection of 1667 cities indicates the robustness of the methodology in classifying and identifying typologies in the respective map samples through the SOM (see Figure \ref{fig:world}).

% Maybe we should add a map segment of melbourne CBD and which other areas in the world are similar.

% Future
This method can now be deployed to find correlations with other indicators, to help planners and designers create a path to a desirable future and help manage and govern large urban entities by avoiding past pitfalls. The logical consequence is to test the methodology towards its predictive power and application in design, planning, and management of urban systems.
% Future Work
%% Find correlations with other indicators
Since this methodology promises to be fundamental and applicable across many fields, the aim of future investigations is to find correlations between urban typologies and other indicators, such as energy intensity, particulate matter, or economic statistics, all factors impacting the health and well-being of urban dwellers across the globe. 
% I felt that this is the perfect sentance to end with and moved the other one one paragraph up (%Future)
...
\begin{figure}
\centering    
\includegraphics[scale=0.25]{Images/SomImages_grid.png}  
\caption{\bf  A visualisation of the 2-dimensional 100x100 SOM trained with 1.7 million map images from 1667 cities.  Each x,y point shows a representative image associated with each node while nodes without associated images are shown in black. Border shows colour coding scheme for SOM x,y locations used in following figures. }    
...
\begin{figure}
\centering    
a)\includegraphics[scale=0.15]{Images/CaseStudy/NewYork-NewarkUnitedStatesofAmerica.png}   
b)\includegraphics[scale=0.15]{Images/CaseStudy/TokyoJapankde.png}   
c)\includegraphics[scale=0.15]{Images/CaseStudy/ParisFrancekde.png}  
d)\includegraphics[scale=0.15]{Images/CaseStudy/JakartaIndonesiakde.png}  
e)\includegraphics[scale=0.15]{Images/CaseStudy/BeijingChinakde.png}  
f)\includegraphics[scale=0.15]{Images/CaseStudy/BarcelonaSpainkde.png}  
g)\includegraphics[scale=0.15]{Images/CaseStudy/SydneyAustraliakde.png}  
h)\includegraphics[scale=0.15]{Images/CaseStudy/MelbourneAustraliakde.png}  
i)\includegraphics[scale=0.15]{Images/CaseStudy/BrasiliaBrazilkde.png}  
j)\includegraphics[scale=0.15]{Images/CaseStudy/NairobiKenyakde.png}   
k)\includegraphics[scale=0.15]{Images/CaseStudy/compare.png}  
%\includegraphics[scale=0.13]{Images/CaseStudy/XXX.png}  
%\includegraphics[scale=0.13]{Images/CaseStudy/XXX.png}  
%\includegraphics[scale=0.13]{Images/CaseStudy/XXX.png}  
%\includegraphics[scale=0.13]{Images/CaseStudy/XXX.png}  
%\includegraphics[scale=0.13]{Images/CaseStudy/XXX.png}  
...
\caption{\bf Kernel density maps of SOM x,y locations for cities a) New York, b) Tokyo, c) Paris, d) Jakarta, e) Beijing, f) Barcelona, g) Sydney, h) Melbourne, i) Bras\'{i}lia, j) Nairobi, and all 10 cities on a single plot.  }    
 \label{fig:kernel}  
\end{figure} 
...
\begin{figure}
\centering    
a)\includegraphics[trim={0 3201px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsNewYorkNewarkUnitedStatesofAmerica.png}   
b)\includegraphics[trim={0 9601px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsTokyoJapan.png}   
c)\includegraphics[trim={0 2561px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsParisFrance.png}  
d)\includegraphics[trim={0 5761px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsJakartaIndonesia.png}  
e)\includegraphics[trim={0 8641px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsBeijingChina.png}  
f)\includegraphics[trim={0 3201px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsBarcelonaSpain.png}  
g)\includegraphics[trim={0 4801px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsSydneyAustralia.png}  
h)\includegraphics[trim={0 5761px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsMelbourneAustralia.png} 
i)\includegraphics[trim={0 2881px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsBrasiliaBrazil.png}  
j)\includegraphics[trim={0 10241px 0 0},clip,scale=0.15]{Images/CaseStudy/MapsNairobiKenya.png}   
...
\KwResult{Histogram of region sizes and region regularity for an image}
 ...
 \While{Locate next white pixel by iterating across rows and columns}{
  Floodfill area using boundaries of all non-white colors (i.e. black, green, blue, orange);\\
  Count pixel size of region;\\  
  Construct a the smallest bounding box of the cloud of points in the region using the Fast Convex Hull algorithm\cite{Javagl2017,GoogleArchive2011};\\
...
\begin{figure}
\centering    
  \includegraphics[scale=0.13]{Images/Histograms/2_47.png}   
  \includegraphics[scale=0.13]{Images/Histograms/5_49.png}   
  \includegraphics[scale=0.13]{Images/Histograms/25_38.png}   
  \includegraphics[scale=0.13]{Images/Histograms/31_70.png}   
  \includegraphics[scale=0.13]{Images/Histograms/31_76.png}   
  \includegraphics[scale=0.13]{Images/Histograms/31_80.png}   
  \includegraphics[scale=0.13]{Images/Histograms/32_47.png}   
  \includegraphics[scale=0.13]{Images/Histograms/36_10.png}   
  \includegraphics[scale=0.13]{Images/Histograms/52_97.png}   
  \includegraphics[scale=0.13]{Images/Histograms/82_98.png}   
\\
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_2_47.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_5_49.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_25_38.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_31_70.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_31_76.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_31_80.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_32_47.png}    
  \includegraphics[scale=0.0235]{Images/Histograms/Hist_36_10.png}    
...
Frank, Lawrence D., Brian Stone Jr, and William Bachman. "Linking land use with household vehicle emissions in the central Puget Sound: methodological framework and findings." Transportation Research Part D: Transport and Environment 5.3 (2000): 173-196.
