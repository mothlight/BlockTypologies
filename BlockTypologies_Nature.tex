...
\begin{figure}
\centering    
\includegraphics[scale=0.04]{Images/SomImages_grid.png}  
...
\caption{\bf Kernel density maps of SOM x,y locations for cities a) New York, b) Tokyo, c) Paris, d) Jakarta, e) Beijing, f) Barcelona, g) Sydney, h) Melbourne, i) Bras\'{i}lia, and j) Nairobi.  }    
 \label{fig:kernel}  
\end{figure} 
