...
\caption{\bf  1692 world cities sampled with inserts showing detail of (left) San Francisco, (centre) Nairobi, and (right) Tokyo. City details use the same SOM x,y location colour scheme as Figure \ref{fig:mel23000}.}    
 \label{fig:world}  
\end{figure} 
...
% % this section is from the methodology document
