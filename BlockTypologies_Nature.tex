...
\begin{equation} 
radiusDecay = r * e^{-1 * i / c}
\end{equation}
where radius $r$ is $100/2=50$, $i$ is the current training iteration (of a total iteration of $n$ = 3.2 million), and time constant $c$ is $n / \log _{10} (radius)$. Learn decay $d$ is calculated as
\begin{equation} 
d = r * e^{-1 * i / c}
\end{equation}
where learn rate $r$ = 0.05.
