...
% City's 'uniqueness' 
As cities grow and evolve, the road networks and urban block structure provides clues as to the process and governance under which this growth occurred. 
% Implication of city structure and form
Understanding the build environemnt % and in particular / especially the road network and block typology,%
...
% our solution
We propose a novel quantitative and objective method to discover city typologies on the neighborhood scale of street patterns by evaluating city block towards size and regularity. This follows \cite{Louf2014a}'s finding that a systematic quantitative method to identify different neighborhoods is currently lacking. 
