...
\caption{\bf  A visualisation of the 2-dimensional 100x100 SOM trained with 1.7 million map images from 1692 cities.  Each x,y point shows a representative image associated with each node while nodes without associated images are shown in black.}    
...
\begin{figure}
\centering    
\includegraphics[scale=0.20]{Images/Figure_3_World-01.jpg}  
\caption{\bf  1692 world cities sampled with inserts showing detail of (left) San Francisco, (centre) Nairobi, and (right) Tokyo. City detail maps use the same SOM x,y location colour scheme as Figure \ref{fig:mel23000}.}    
 \label{fig:world}  
\end{figure} 
...
% % % end of paste from Paris End introduction





%% XXX copy of introduction?
% % these two paragraphs are a repeat of above, commenting out
...
\KwResult{Histogram of region sizes and region regularity for an image}
 ...
 \While{Locate next white pixel by iterating across rows and columns}{
  ...
  Construct a bounding box of the cloud of points in the region using Fast Convex Hull;\\
